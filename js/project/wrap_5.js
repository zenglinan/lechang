...
//-------------类和对象---------------
    ...
    indexOfFunc.prototype={
      ...
      setControlWidthTall:function (funcName,tg,data) {
          ...
          if(data[2]){
              var ad = new el_new(null,null,null,'a');
              $(tg).parents('.td').empty().append(ad.dom)
              ad.dom.href = data[2];
              $(ad.dom).append($(tgAccept));
...
function controlWidthTall() {
    ...
    var labelDiv3 = new labelAndInput('form-control', "controlColumnType", "", "input", "链接");
    labelDiv.inputType('number');
    labelDiv2.inputType('number');
    labelDiv3.dom.style.maxWidth="120px"
    elDiv.dom.append(labelDiv.labelEl);
